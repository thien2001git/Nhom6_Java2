...
public class HomeController implements Initializable{
	...
	public void QLTD_GUI(ActionEvent e) {
		try {
			Parent root = FXMLLoader.load(this.getClass().getResource("/application/View/QLTD.fxml"));
	...
	public void QLNS_GUI(ActionEvent e) {
		try {
			Parent root = FXMLLoader.load(this.getClass().getResource("/application/View/QLNS.fxml"));
			Scene scene = new Scene(root, 1300, 650);
			scene.getStylesheets().add(getClass().getResource("/application/login.css").toExternalForm());
	...
	public void QLL_GUI(ActionEvent e) {
		try {
			Parent root = FXMLLoader.load(this.getClass().getResource("/application/View/QLL.fxml"));
